# Q.1 Write a program to accept two numbers from the user and perform division. 
...
# Q.2 Write a program to accept a number from the user and check whether it’s prime or not. 
...
# Q.4 Declare a list with 10 integers and ask the user to enter an index. Check whether the number in that index is positive or negative number. 
