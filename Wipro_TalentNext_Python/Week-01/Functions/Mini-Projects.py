...
import Functions.string_utils as string_utils
string = input("Enter name: ")
string_utils.ispalindrome(string)
string_utils.count_the_vowels(string)
string_utils.frequency_of_letters(string)